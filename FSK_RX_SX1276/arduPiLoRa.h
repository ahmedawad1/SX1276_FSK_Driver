...
//FREQUENCY CHANNELS:
const uint32_t CH_10_868 = 0xD84CCC; // channel 10, central freq = 865.20MHz // RegFrf is responsible for setting the frequency 
...
const uint8_t OFFSET_PAYLOADLENGTH = 5; // it is for dst, src , pac_num , length , packet_rtry extra fields defined by libelium
const uint8_t OFFSET_RSSI = 137;
const uint8_t NOISE_FIGURE = 6.0;
const uint8_t NOISE_ABSOLUTE_ZERO = 174.0;
const uint16_t MAX_TIMEOUT = 60;		//8000 msec = 8.0 sec
