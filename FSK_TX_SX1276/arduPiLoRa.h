...
const uint8_t OFFSET_PAYLOADLENGTH = 5; // these offset is used for the additional fields sent in the message defined by libelium which are : [destination,src,packet_num,length,Retry_num] 
const uint8_t OFFSET_RSSI = 137;
const uint8_t NOISE_FIGURE = 6.0;
const uint8_t NOISE_ABSOLUTE_ZERO = 174.0;
const uint16_t MAX_TIMEOUT = 20000;		//8000 msec = 8.0 sec
